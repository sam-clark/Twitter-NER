...
#os.system("java -Xmx1024m -cp mallet-2.0.6/lib/mallet-deps.jar:mallet-2.0.6/dist/mallet.jar cc.mallet.fst.SimpleTagger --include-input true --test seg=B-loc.I-loc,B-per.I-per,B-org.I-org,B-event.I-event,B-company.I-company,B-product.I-product,B-internetwebsite.I-internetwebsite,B-musicartist.I-musicartist,B-venue.I-venue,B-film.I-film,B-tvshow.I-tvshow,B-sportsteam.I-sportsteam,B-other.I-other --model-file %s %s" % (sys.argv[1], sys.argv[2]))

#os.system("java -Xmx1024m -cp mallet-2.0.6/lib/mallet-deps.jar:mallet-2.0.6/dist/mallet.jar cc.mallet.fst.SimpleTagger --include-input true --test seg=B-geo-loc.I-geo-loc,B-holiday.I-holiday,B-person.I-person,B-gov-agency.I-gov-agency,B-other.I-other,B-company.I-company,B-product.I-product,B-musicartist.I-musicartist,B-facility.I-facility,B-movie.I-movie,B-tvshow.I-tvshow,B-sportsteam.I-sportsteam --model-file %s %s" % (sys.argv[1], sys.argv[2]))

os.system("java -Xmx1024m -cp mallet-2.0.6/lib/mallet-deps.jar:mallet-2.0.6/dist/mallet.jar cc.mallet.fst.SimpleTagger --include-input true --test seg=B-loc.I-loc,B-per.I-per,B-org.I-org --model-file %s %s" % (sys.argv[1], sys.argv[2]))
